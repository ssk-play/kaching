...
zip -q -r "$out" \
  ...
  background.js playconsole.js settings.js filters.js format.js fx.js health.js i18n.js ledger.js llm.js log.js orders.js subs.js telegram.js testorders.js totals.js \
