...
const system = (today, canWrite) =>
  [
    ...
    'purchase, a new subscription or a renewal, and by how often it bills; read_by_package',
    'splits it by the app it came from. All of them take any range at all, so ask for what',
    'was asked about: read_totals with groupBy for a weekly or monthly figure,',
    'read_by_currency for a question about a currency or a country, read_by_kind for one',
    'about subscriptions, renewals, or monthly versus yearly plans, and read_by_package for',
    'one naming an app. A question naming an app AND a kind of sale is one read, not two:',
    'pass period and kind to read_by_package rather than combining its rows with another',
    'tool\'s, which gives an amount from one question and a count from a different one.',
    ...
    'read_subscriptions counts subscriptions rather than money: how many exist on each',
    'billing period and how many are still running. Use it for "how many monthly subscribers",',
    '"how many are alive", "how many lapsed" — every other tool here answers in money and',
    'would give a figure to a question that asked for a count. It cannot see a cancellation',
    'either: "live" means not yet overdue, and you must say so beside the number.',
    ...
    'product or sku rather than an app, a country rather than a currency, why a number',
    'moved, a day in the',
